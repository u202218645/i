...
public:
    Hotel(string nombre, int numHabitaciones) : nombre(nombre), numHabitaciones(numHabitaciones), habitacionesDisponibles(numHabitaciones) {}

    string getNombre() const {
        return nombre;
    }

    int getHabitacionesDisponibles() const {
        return habitacionesDisponibles;
    }

    bool reservarHabitacion() {
